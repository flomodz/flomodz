...
--
REWARDS.Database = {}
REWARDS.Database.Host = 'localhost' -- MySQL host/server IP
REWARDS.Database.Username = 'username' -- MySQL username
REWARDS.Database.Password = 'password' -- MySQL password
REWARDS.Database.DatabaseName = 'databasename' -- MySQL database
