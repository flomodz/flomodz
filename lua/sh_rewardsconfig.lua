...
REWARDS.Settings.SteamGroupPage = "https://steamcommunity.com/groups/nolipserp"
...
REWARDS.Settings.GroupName = "Nolipse RolePlay"
REWARDS.Settings.ShowOnPlayerConnect = true --Open steam rewards when players not in group connect
REWARDS.Settings.AutoCloseTime = 20 --Auto close steam rewards after certain time (seconds)
REWARDS.Settings.SuccessCloseTime = 10 --Auto close steam rewards after success (seconds)
...
REWARDS.JoinButtonText = "Rejoignez le groupe Steam" --Text on join button
REWARDS.DontJoinButtonText = "Pas maintenant, merci" --Text on don't join (Close) button
--Message box text (e.g. explain the rewards of joining your group)
REWARDS.Settings.RewardsMessage = "Rejoignez notre groupe steam et obtenez 100 000 dollars !"
--Message box text on success (e.g. explain what rewards we're given)
REWARDS.Settings.RewardsSuccessMessage = "Merci d'avoir rejoint le groupe ! Vous avez reçu vos points et votre chapeau!"
--Message box text on check (e.g. explain that a check is happening)
REWARDS.Settings.RewardsJoinCheckMessage = "Vérification de l'appartenance à un groupe Steam..."
...
REWARDS.Settings.RewardsChatMessage = "Rejoignez notre groupe steam et recevez une récompense !"
...
REWARDS.Settings.DarkRPCashReward = 100000 --DarkRP Cash Reward (Set to 0 to disable)
...
REWARDS.Settings.PointshopItemReward = {"ninjaturtle"} --Change to {} to disable
...
REWARDS.Settings.Pointshop2StandardPoints = 1000
REWARDS.Settings.Pointshop2PremiumPoints = 100
...
REWARDS.Settings.Pointshop2Item = {"Hotdog Hat"} --Change to {} to disable
